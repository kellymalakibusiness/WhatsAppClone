...
import com.malakiapps.whatsappclone.android.compose.screens.calls_screen.CallRow
import com.malakiapps.whatsappclone.android.compose.screens.calls_screen.CallType
import com.malakiapps.whatsappclone.android.compose.screens.calls_screen.CallsScreen
import com.malakiapps.whatsappclone.android.compose.screens.chat_screen.ChatScreen
import com.malakiapps.whatsappclone.android.compose.screens.communities_screen.CommunitiesScreen
import com.malakiapps.whatsappclone.android.compose.screens.communities_screen.CommunityGroup
import com.malakiapps.whatsappclone.android.compose.screens.communities_screen.CommunityItem
import com.malakiapps.whatsappclone.android.compose.screens.dashboard.DashboardScreenType.Companion.indexToDashboardScreenType
import com.malakiapps.whatsappclone.android.compose.screens.updates_screen.UpdatesScreen
import kotlinx.coroutines.launch

@Composable
fun DashboardScreen(shimmerState: Boolean, openSettings: () -> Unit, modifier: Modifier = Modifier) {
    //TODO('Add the actual shimmer effect on the messages')
    ...
    LaunchedEffect(pagerScrollState.isScrollInProgress) {
        if(!pagerScrollState.isScrollInProgress && !shimmerState){
