...
expect interface AnonymousUserMessageRepository {
    suspend fun getConversation(owner: Email): Response<Conversation, GetMessagesError>

    suspend fun sendMessage(message: Message): Response<Message, SendMessagesError>

    suspend fun updateMessage(updateMessage: UpdateMessage): Response<Message, UpdateMessageError>

    suspend fun deleteMessage(owner: Email, timeId: String): Response<Unit, DeleteMessageError>
}